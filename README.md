...
def random_string_generator(str_size: int, chars = "<>-"):
...
if __name__ == "__main__":
    hallways = [random_string_generator(randint(2, 100)) for _ in range(1, 10)]
